...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ParsedPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parsed_page");

                    b.HasIndex("DocumentId")
                        .HasDatabaseName("ix_parsed_page_document_id");

                    b.ToTable("parsed_page", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ParsedPage", b =>
                {
                    b.HasOne("Domain.Entities.Document", "Document")
                        .WithMany("ParsedPages")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_parsed_page_documents_document_id");
