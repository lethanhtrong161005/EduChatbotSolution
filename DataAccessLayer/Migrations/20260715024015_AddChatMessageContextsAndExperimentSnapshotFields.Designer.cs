...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260715024015_AddChatMessageContextsAndExperimentSnapshotFields")]
    partial class AddChatMessageContextsAndExperimentSnapshotFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ChatMessageContext", b =>
                {
                    ...
                    b.ToTable("chat_message_contexts", null, t =>
                        {
                            t.HasCheckConstraint("ck_chat_message_contexts_context_index", "context_index >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CitationOccurrence", b =>
                {
                    ...
                    b.HasIndex("CitationId")
                        .HasDatabaseName("ix_citation_occurrences_citation_id");

                    b.ToTable("citation_occurrences", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.TestResponseContext", b =>
                {
                    ...
                    b.ToTable("test_response_contexts", null, t =>
                        {
                            t.HasCheckConstraint("ck_test_response_contexts_context_index", "context_index >= 0");
                        });
                });
