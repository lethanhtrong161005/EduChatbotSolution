...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260717200039_NormalizePersistedOrdinalsToOneBased")]
    partial class NormalizePersistedOrdinalsToOneBased
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ChatMessageContext", b =>
                {
                    ...
                    b.Property<int>("ContextIndex")
                        .HasColumnType("integer")
                        .HasColumnName("context_index");
                    ...
                    b.HasIndex("ChatMessageId", "ContextIndex")
                        .IsUnique()
                        .HasDatabaseName("ix_chat_message_contexts_chat_message_id_context_index");

                    b.ToTable("chat_message_contexts", null, t =>
                        {
                            t.HasCheckConstraint("ck_chat_message_contexts_context_index", "context_index >= 1");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.TestResponseContext", b =>
                {
                    ...
                    b.HasIndex("TestResponseId", "ContextIndex")
                        .IsUnique()
                        .HasDatabaseName("ix_test_response_contexts_test_response_id_context_index");

                    b.ToTable("test_response_contexts", null, t =>
                        {
                            t.HasCheckConstraint("ck_test_response_contexts_context_index", "context_index >= 1");
                        });
                });
