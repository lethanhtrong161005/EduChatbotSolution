...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260713223010_AddChunkEndLocations")]
    partial class AddChunkEndLocations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Chunk", b =>
                {
                    ...
                    b.ToTable("chunks", null, t =>
                        {
                            t.HasCheckConstraint("ck_chunks_end_page_number", "end_page_number >= start_page_number");
                        });
                });
