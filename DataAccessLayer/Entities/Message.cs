...
/// <summary>Defines the possible sender roles within a conversation.</summary>
public enum SenderRole
{
    /// <summary>A human user message.</summary>
    User,
    /// <summary>An AI assistant response.</summary>
    Assistant,
    /// <summary>A system prompt or instruction.</summary>
    System,
}
