...
public sealed class AdminReportRepositoryIntegrationTests
{
    ...
    private async Task SeedDashboardScenarioAsync()
    {
        await _context.Database.ExecuteSqlRawAsync(
            ...
            INSERT INTO chunks (id, document_id, chunk_index, chunk_text, chunking_strategy) VALUES
                ('50000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', 1, 'Alpha one', 'FixedLength'),
                ('50000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000001', 2, 'Alpha two', 'FixedLength'),
                ('50000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000002', 1, 'Beta one', 'FixedLength'),
                ('50000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000003', 1, 'Gamma one', 'FixedLength');
