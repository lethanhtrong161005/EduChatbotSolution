    ...
    public override async Task OnConnectedAsync()
    {
        ...
        switch (pageType)
        {
            case PageType_DocumentLibrary:
                await Groups.AddToGroupAsync(Context.ConnectionId, HubGroups.DocumentStatus());
                return;
            case PageType_DocumentDetails:
                ...
                await Groups.AddToGroupAsync(Context.ConnectionId, HubGroups.DocumentStatus(docId));
                return;
            default:
                goto ABORT_CONN;
        }
