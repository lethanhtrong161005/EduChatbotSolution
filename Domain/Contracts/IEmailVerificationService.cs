...
public interface IEmailVerificationService
{
  ...
  /// <summary>
  /// Returns the remaining TTL (in seconds) of the OTP key in Redis.
  /// Returns 0 if the key has already expired or does not exist.
  /// </summary>
  /// <param name="email">The email address whose OTP TTL to query.</param>
  Task<int> GetOtpRemainingSecondsAsync(string email);
